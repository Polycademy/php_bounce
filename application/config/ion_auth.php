...
*/
$config['tables']['users']           = 'bounce_users';
$config['tables']['groups']          = 'bounce_groups';
$config['tables']['users_groups']    = 'bounce_users_groups';
$config['tables']['login_attempts']  = 'bounce_login_attempts';
 ...
 */
$config['site_title']           = "PHP Bounce";					// Site Title, example.com
$config['admin_email']          = "enquiry@polycademy.com"; 	// Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 40000; 						// The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
