...
/*
|--------------------------------------------------------------------------
| Third Party Classes to Autoload
|--------------------------------------------------------------------------
|
| Nothing to do with the Autoloader
|
*/
require_once(APPPATH . 'third_party/php-parser/lib/bootstrap.php');
...
|--------------------------------------------------------------------------
|
| This is overwritten by laptop_development, desktop_development & production config
|
*/
$config['php_binary'] = false;
...
|
*/
$config['encryption_key'] = 'GDH&F%*(W)UJ#)_@()&$*YHSFO*&T^FG';
...
|
*/
$config['cookie_prefix']	= 'phpbounce_';
